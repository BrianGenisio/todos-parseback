...
(((window, undefined) => {
    ...
    jQuery.extend({
        ...
        Deferred(func) {
            ...
            jQuery.extend( deferred, {
                ...
                always(...args) {
                    return deferred.done(...args).fail.apply( this, args );
                },
    ...
    jQuery.event = {
        ...
        trigger(event, data, elem, onlyHandlers) {
            ...
            var // IE doesn't like method names with a colon (#3533, #8272)
            ...
            do {
                ...
                if ( ontype && jQuery.acceptData( cur ) && cur[ ontype ] && cur[ ontype ](...data) === false ) {
                    event.result = false;
                    event.preventDefault();
                }
